...
var Slot2 = React9.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime5.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React9.isValidElement(newElement) ? React9.cloneElement(newElement, void 0, newChildren) : null });
  }
...
var useLayoutEffect22 = Boolean(globalThis == null ? void 0 : globalThis.document) ? React16.useLayoutEffect : () => {
};
