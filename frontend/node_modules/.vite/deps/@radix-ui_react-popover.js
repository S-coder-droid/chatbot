...
import {
  ...
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-YXXNLFZV.js";
import {
  createSlot
} from "./chunk-PLVHZGUF.js";
import {
  RemoveScrollBar,
  __assign,
  __rest,
...
var PopperAnchor = React16.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime8.jsx)(Primitive4.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var Portal = React18.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime10.jsx)(Primitive5.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function useComposedRefs5(...refs) {
  return React19.useCallback(composeRefs5(...refs), refs);
}
...
var Presence = (props) => {
  ...
  const ref = useComposedRefs5(presence.ref, getElementRef(child));
...
// node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect = React24[" useInsertionEffect ".trim().toString()] || useLayoutEffect2;
...
var RemoveScroll = React26.forwardRef(function(props, parentRef) {
  ...
  return React26.createElement(
    React26.Fragment,
    null,
    enabled && React26.createElement(SideCar, { sideCar: effectCar, removeScrollBar, shards, noRelative, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
function RemoveScrollSideCar(props) {
  ...
  var Style = React27.useState(styleSingleton)[0];
  ...
  return React27.createElement(
    React27.Fragment,
    null,
    inert ? React27.createElement(Style, { styles: generateStyle(id) }) : null,
...
var PopoverTrigger = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    const trigger = (0, import_jsx_runtime12.jsx)(
      Primitive6.button,
      {
        type: "button",
    ...
    return context.hasCustomAnchor ? trigger : (0, import_jsx_runtime12.jsx)(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime12.jsx)(PortalProvider, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime12.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime12.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var PopoverContent = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime12.jsx)(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime12.jsx)(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var PopoverContentModal = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(Combination_default, { as: Slot, allowPinchZoom: true, children: (0, import_jsx_runtime12.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
